...
**Project**: theme-visualizer-express 

**URL**: https://run.gptengineer.app/projects/REPLACE_WITH_PROJECT_ID/improve

**Description**: Create a visual Material 3 theme editor. It should output a Material 3 JSON theme. Colours should be able to be picked visually with colour pickers, and previewed on Material components. 
...
```sh
git clone https://github.com/GPT-Engineer-App/theme-visualizer-express.git
cd theme-visualizer-express
npm i
